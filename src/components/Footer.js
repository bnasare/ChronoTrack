const navigation = [
  {
    name: "YouTube",
    href: "https://www.youtube.com/@JeronDev",
    icon: (props) => (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/bank.himself",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/_bornContrarian",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="px-6 py-12 mx-auto max-w-7xl md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-xs leading-5 text-center text-gray-500">
            &copy; {new Date().getFullYear()} Tevrozo Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
